...
HD_PWD='C:/Users/mahfu/OneDrive/Desktop/EEE 304 Project files/Compensated clock/project_compensated_clock/project_compensated_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compensated_clock_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compensated_clock_top.tcl
