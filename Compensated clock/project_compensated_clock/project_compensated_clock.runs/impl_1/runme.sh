...
HD_PWD='C:/Users/mahfu/OneDrive/Desktop/EEE 304 Project files/Compensated clock/project_compensated_clock/project_compensated_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log compensated_clock_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source compensated_clock_top.tcl -notrace
