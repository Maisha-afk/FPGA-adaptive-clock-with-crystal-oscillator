...
HD_PWD='C:/Users/mahfu/OneDrive/Desktop/EEE 304 Project files/Uncompensated clock/project_uncompensated_clock/project_uncompensated_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_clock_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_clock_top.tcl
