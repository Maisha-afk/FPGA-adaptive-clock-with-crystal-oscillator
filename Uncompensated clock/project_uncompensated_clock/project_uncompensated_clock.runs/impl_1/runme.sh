...
HD_PWD='C:/Users/mahfu/OneDrive/Desktop/EEE 304 Project files/Uncompensated clock/project_uncompensated_clock/project_uncompensated_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_clock_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_clock_top.tcl -notrace
