## Nexys A7-100T Constraints for adaptive_clock_top
## FPGA-Based Adaptive Digital Clock with Drift Correction
...
## ============================================================
## Reset — CPU reset button (active-low)
## ============================================================
...
## ============================================================
set_property -dict { PACKAGE_PIN N17 IOSTANDARD LVCMOS33 } [get_ports {BTNC}]  ;# Center — Toggle display
set_property -dict { PACKAGE_PIN M18 IOSTANDARD LVCMOS33 } [get_ports {BTNU}]  ;# Up     — Set mode
set_property -dict { PACKAGE_PIN M17 IOSTANDARD LVCMOS33 } [get_ports {BTNR}]  ;# Right  — Increment
set_property -dict { PACKAGE_PIN P17 IOSTANDARD LVCMOS33 } [get_ports {BTNL}]  ;# Left   — Reserved
set_property -dict { PACKAGE_PIN P18 IOSTANDARD LVCMOS33 } [get_ports {BTND}]  ;# Down   — Reserved
